...
require 'AbstractRecurrent'

local Recurrent, parent = torch.class('nn.Recurrent1', 'nn.AbstractRecurrent1')
...
function Recurrent:buildRecurrentModule(T)
   ...
   for t = 2, T do
     self.sharedClones[t] = self.recurrentModule:clone('weight', 'bias', 'gradWeight', 'gradBias')
   end
end
